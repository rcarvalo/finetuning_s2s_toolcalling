...
GUIDE_VISITOR = {
    "name": "guide_visitor",
    "description": "Donne l'itinéraire vers un lieu des locaux (salle, accueil, cafétéria...) et déclenche le geste d'orientation du robot.",
    "parameters": {
        "type": "object",
        "properties": {
...
NOTIFY_RECEPTIONIST = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "urgency": {"type": "string", "enum": ["low", "normal", "high"], "description": "Niveau d'urgence."},
        },
        "required": ["reason"],
    },
}
...
QUERY_DATABASE = {
    "name": "query_database",
    "description": "Exécute une requête SQL en LECTURE SEULE (SELECT) sur la base PostgreSQL interne (employés, rendez-vous, lieux).",
    "parameters": {
        "type": "object",
        "properties": {
            "sql": {"type": "string", "description": "Requête SELECT (une seule instruction, sans modification de données)."},
        },
        "required": ["sql"],
    },
}
...
SEARCH_KNOWLEDGE_BASE = {
    ...
    "description": "Recherche dans la base de connaissances de l'entreprise (projets, équipes, FAQ) et retourne les passages pertinents.",
    "parameters": {
        "type": "object",
        "properties": {
